...
namespace alps.net_api
{
    ...
    /// 
    /// </summary>
    public class PrecedenceTransitionType : AbstractPASSTransition
    {
        /// <summary>
        /// 
        /// </summary>
        public PrecedenceTransitionType()
        {
        ...
        public PrecedenceTransitionType(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition)
        {
