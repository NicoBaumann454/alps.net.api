...
<html>
  ...
  <head>
    ...
    <title>Class ReminderTransition
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class ReminderTransition
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.ReminderTransition">
  
  
  <h1 id="alps__net_api_ReminderTransition" data-uid="alps_.net_api.ReminderTransition" class="text-break">Class ReminderTransition
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/alps_.net_api.ReminderTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Class that represents a reminder transition</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><span class="xref">ReminderTransition</span></div>
      <div class="level7"><a class="xref" href="alps_.net_api.CalenderBasedReminderTransition.html">CalenderBasedReminderTransition</a></div>
      <div class="level7"><a class="xref" href="alps_.net_api.TimeBasedReminderTransition.html">TimeBasedReminderTransition</a></div>
  </div>
  ...
  <h5 id="alps__net_api_ReminderTransition_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class ReminderTransition : TimeTransition, IReminderTransition, ITimeTransition, ITransition, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_ReminderTransition__ctor_" data-uid="alps_.net_api.ReminderTransition.#ctor*"></a>
  <h4 id="alps__net_api_ReminderTransition__ctor" data-uid="alps_.net_api.ReminderTransition.#ctor">ReminderTransition()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.ReminderTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new empty instance of the reminder transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public ReminderTransition()</code></pre>
  </div>
  
  
  <a id="alps__net_api_ReminderTransition__ctor_" data-uid="alps_.net_api.ReminderTransition.#ctor*"></a>
  <h4 id="alps__net_api_ReminderTransition__ctor_System_Collections_Generic_List_System_String__System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_alps__net_api_Action_alps__net_api_State_alps__net_api_State_alps__net_api_TransitionCondition_" data-uid="alps_.net_api.ReminderTransition.#ctor(System.Collections.Generic.List{System.String},System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,alps_.net_api.Action,alps_.net_api.State,alps_.net_api.State,alps_.net_api.TransitionCondition)">ReminderTransition(List&lt;String&gt;, String, List&lt;String&gt;, String, SubjectBehavior, Action, State, State, TransitionCondition)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.ReminderTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new fully specified instance of the reminder transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public ReminderTransition(List&lt;string&gt; additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition)</code></pre>
  </div>
  ...
  <h4 id="alps__net_api_ReminderTransition_className" data-uid="alps_.net_api.ReminderTransition.className">className</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.ReminderTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;ReminderTransition&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_ReminderTransition_factoryMethod_" data-uid="alps_.net_api.ReminderTransition.factoryMethod*"></a>
  <h4 id="alps__net_api_ReminderTransition_factoryMethod" data-uid="alps_.net_api.ReminderTransition.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.ReminderTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Factory method that creates and returns a new empty instance of the reminder transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public ReminderTransition factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.ReminderTransition.html">ReminderTransition</a></td>
        <td><p sourcefile="obj/api/alps_.net_api.ReminderTransition.yml" sourcestartlinenumber="1" sourceendlinenumber="1">A new empty instance of the reminder transition class</p>
</td>
      </tr>
    </tbody>
  </table>
