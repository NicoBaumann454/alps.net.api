...
<html>
  ...
  <head>
    ...
    <title>Interface IChoiceSegment
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface IChoiceSegment
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.IChoiceSegment">
  
  
  <h1 id="alps__net_api_IChoiceSegment" data-uid="alps_.net_api.IChoiceSegment" class="text-break">Interface IChoiceSegment
  </h1>
  <div class="markdown level0 summary"><p>Interface to the choice segment class</p>
</div>
  ...
  <h5 id="alps__net_api_IChoiceSegment_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IChoiceSegment : IState, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="methods">Methods
  </h3>
  
  
  <a id="alps__net_api_IChoiceSegment_factoryMethod_" data-uid="alps_.net_api.IChoiceSegment.factoryMethod*"></a>
  <h4 id="alps__net_api_IChoiceSegment_factoryMethod" data-uid="alps_.net_api.IChoiceSegment.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">ChoiceSegment factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.ChoiceSegment.html">ChoiceSegment</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_IChoiceSegment_getChoiceSegmentPath_" data-uid="alps_.net_api.IChoiceSegment.getChoiceSegmentPath*"></a>
  <h4 id="alps__net_api_IChoiceSegment_getChoiceSegmentPath" data-uid="alps_.net_api.IChoiceSegment.getChoiceSegmentPath">getChoiceSegmentPath()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">IList&lt;IChoiceSegmentPath&gt; getChoiceSegmentPath()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Collections.Generic.IList</span>&lt;<a class="xref" href="alps_.net_api.IChoiceSegmentPath.html">IChoiceSegmentPath</a>&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_IChoiceSegment_setContainsChoiceSegmentPath_" data-uid="alps_.net_api.IChoiceSegment.setContainsChoiceSegmentPath*"></a>
  <h4 id="alps__net_api_IChoiceSegment_setContainsChoiceSegmentPath_System_Collections_Generic_IList_alps__net_api_IChoiceSegmentPath__" data-uid="alps_.net_api.IChoiceSegment.setContainsChoiceSegmentPath(System.Collections.Generic.IList{alps_.net_api.IChoiceSegmentPath})">setContainsChoiceSegmentPath(IList&lt;IChoiceSegmentPath&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">void setContainsChoiceSegmentPath(IList&lt;IChoiceSegmentPath&gt; choiceSegmentPaths)</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Collections.Generic.IList</span>&lt;<a class="xref" href="alps_.net_api.IChoiceSegmentPath.html">IChoiceSegmentPath</a>&gt;</td>
        <td><span class="parametername">choiceSegmentPaths</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
