...
<html>
  ...
  <head>
    ...
    <title>Class UserCancelTransition
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class UserCancelTransition
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.UserCancelTransition">
  
  
  <h1 id="alps__net_api_UserCancelTransition" data-uid="alps_.net_api.UserCancelTransition" class="text-break">Class UserCancelTransition
  </h1>
  <div class="markdown level0 summary"><p>Class that represents a user cancel transition </p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">UserCancelTransition</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="alps_.net_api.IUserCancelTransition.html">IUserCancelTransition</a></div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="alps_.net_api.Transition.html#alps__net_api_Transition_className">Transition.className</a>
    </div>
    <div>
  ...
  <h5 id="alps__net_api_UserCancelTransition_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class UserCancelTransition : Transition, IUserCancelTransition, ITransition, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_UserCancelTransition__ctor_" data-uid="alps_.net_api.UserCancelTransition.#ctor*"></a>
  <h4 id="alps__net_api_UserCancelTransition__ctor" data-uid="alps_.net_api.UserCancelTransition.#ctor">UserCancelTransition()</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new empty instance of the user cancel transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public UserCancelTransition()</code></pre>
  </div>
  
  
  <a id="alps__net_api_UserCancelTransition__ctor_" data-uid="alps_.net_api.UserCancelTransition.#ctor*"></a>
  <h4 id="alps__net_api_UserCancelTransition__ctor_System_Collections_Generic_List_System_String__System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_alps__net_api_Action_alps__net_api_State_alps__net_api_State_alps__net_api_TransitionCondition_" data-uid="alps_.net_api.UserCancelTransition.#ctor(System.Collections.Generic.List{System.String},System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,alps_.net_api.Action,alps_.net_api.State,alps_.net_api.State,alps_.net_api.TransitionCondition)">UserCancelTransition(List&lt;String&gt;, String, List&lt;String&gt;, String, SubjectBehavior, Action, State, State, TransitionCondition)</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new fully specified instance of the user cancel transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public UserCancelTransition(List&lt;string&gt; additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition)</code></pre>
  </div>
  ...
  <a id="alps__net_api_UserCancelTransition_factoryMethod_" data-uid="alps_.net_api.UserCancelTransition.factoryMethod*"></a>
  <h4 id="alps__net_api_UserCancelTransition_factoryMethod" data-uid="alps_.net_api.UserCancelTransition.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p>Factory method that creates and returns a new empty instance of the user cancel transiton class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public UserCancelTransition factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.UserCancelTransition.html">UserCancelTransition</a></td>
        <td><p>A new empty instance of the user cancel transiton class</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <div>
      <a class="xref" href="alps_.net_api.IUserCancelTransition.html">IUserCancelTransition</a>
  </div>
  <div>
