...
<html>
  ...
  <head>
    ...
    <title>Interface ISendState
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface ISendState
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.ISendState">
  
  
  <h1 id="alps__net_api_ISendState" data-uid="alps_.net_api.ISendState" class="text-break">Interface ISendState
  </h1>
  <div class="markdown level0 summary"><p>Interface to the send type class</p>
</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="alps_.net_api.IBehaviorDescriptionComponent.html#alps__net_api_IBehaviorDescriptionComponent_factoryMethod">IBehaviorDescriptionComponent.factoryMethod()</a>
    </div>
    <div>
  ...
  <h5 id="alps__net_api_ISendState_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface ISendState : IStandartPASSState, IState, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="methods">Methods
  </h3>
  
  
  <a id="alps__net_api_ISendState_getSendFunction_" data-uid="alps_.net_api.ISendState.getSendFunction*"></a>
  <h4 id="alps__net_api_ISendState_getSendFunction" data-uid="alps_.net_api.ISendState.getSendFunction">getSendFunction()</h4>
  <div class="markdown level1 summary"><p>Method that returns the send function attribute of the instance</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">ISendFunction getSendFunction()</code></pre>
  </div>
  ...
  <a id="alps__net_api_ISendState_getSendingFailedTransition_" data-uid="alps_.net_api.ISendState.getSendingFailedTransition*"></a>
  <h4 id="alps__net_api_ISendState_getSendingFailedTransition" data-uid="alps_.net_api.ISendState.getSendingFailedTransition">getSendingFailedTransition()</h4>
  <div class="markdown level1 summary"><p>Method that sets the sending failed transition attribute of the instance</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">ISendingFailedTransition getSendingFailedTransition()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="alps__net_api_ISendState_getSendTransition_" data-uid="alps_.net_api.ISendState.getSendTransition*"></a>
  <h4 id="alps__net_api_ISendState_getSendTransition" data-uid="alps_.net_api.ISendState.getSendTransition">getSendTransition()</h4>
  <div class="markdown level1 summary"><p>Method that returns the send transition attribute of the instance</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">ISendTransition getSendTransition()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="alps__net_api_ISendState_setFunctionSpecification_" data-uid="alps_.net_api.ISendState.setFunctionSpecification*"></a>
  <h4 id="alps__net_api_ISendState_setFunctionSpecification_alps__net_api_ISendFunction_" data-uid="alps_.net_api.ISendState.setFunctionSpecification(alps_.net_api.ISendFunction)">setFunctionSpecification(ISendFunction)</h4>
  <div class="markdown level1 summary"><p>Method that sets the send function attribute of the instance</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">void setFunctionSpecification(ISendFunction sendFunction)</code></pre>
  </div>
  ...
  <a id="alps__net_api_ISendState_setSendingFailedTransition_" data-uid="alps_.net_api.ISendState.setSendingFailedTransition*"></a>
  <h4 id="alps__net_api_ISendState_setSendingFailedTransition_alps__net_api_ISendingFailedTransition_" data-uid="alps_.net_api.ISendState.setSendingFailedTransition(alps_.net_api.ISendingFailedTransition)">setSendingFailedTransition(ISendingFailedTransition)</h4>
  <div class="markdown level1 summary"><p>Method that sets the sending failed transition attribute of the instance</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">void setSendingFailedTransition(ISendingFailedTransition sendingFailedTransition)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="alps__net_api_ISendState_setSendTransition_" data-uid="alps_.net_api.ISendState.setSendTransition*"></a>
  <h4 id="alps__net_api_ISendState_setSendTransition_alps__net_api_ISendTransition_" data-uid="alps_.net_api.ISendState.setSendTransition(alps_.net_api.ISendTransition)">setSendTransition(ISendTransition)</h4>
  <div class="markdown level1 summary"><p>Method that sets the send transition attribute of the instance</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">void setSendTransition(ISendTransition sendTransition)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
