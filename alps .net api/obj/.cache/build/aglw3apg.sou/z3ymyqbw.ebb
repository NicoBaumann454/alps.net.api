...
<html>
  ...
  <head>
    ...
    <title>Interface IDataObjectListDefiniton
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface IDataObjectListDefiniton
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.IDataObjectListDefiniton">
  
  
  <h1 id="alps__net_api_IDataObjectListDefiniton" data-uid="alps_.net_api.IDataObjectListDefiniton" class="text-break">Interface IDataObjectListDefiniton
  </h1>
  <div class="markdown level0 summary"><p>Interface to the data object list definition class</p>
</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="alps_.net_api.IPASSProcessModellElement.html#alps__net_api_IPASSProcessModellElement_factoryMethod">IPASSProcessModellElement.factoryMethod()</a>
    </div>
  </div>
  ...
  <h5 id="alps__net_api_IDataObjectListDefiniton_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IDataObjectListDefiniton : IDataObjectDefiniton, IDataDescribingComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
</article>
          </div>
