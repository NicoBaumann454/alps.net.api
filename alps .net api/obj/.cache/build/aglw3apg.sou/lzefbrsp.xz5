...
<html>
  ...
  <head>
    ...
    <title>Class GenericReturnToOriginReference
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class GenericReturnToOriginReference
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.GenericReturnToOriginReference">
  
  
  <h1 id="alps__net_api_GenericReturnToOriginReference" data-uid="alps_.net_api.GenericReturnToOriginReference" class="text-break">Class GenericReturnToOriginReference
  </h1>
  <div class="markdown level0 summary"><p>Class that represents an GenericReturnToOriginReference</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><span class="xref">GenericReturnToOriginReference</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="alps_.net_api.IGenericReturnToOriginRefrence.html">IGenericReturnToOriginRefrence</a></div>
  ...
  <h5 id="alps__net_api_GenericReturnToOriginReference_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class GenericReturnToOriginReference : State, IGenericReturnToOriginRefrence, IState, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_GenericReturnToOriginReference__ctor_" data-uid="alps_.net_api.GenericReturnToOriginReference.#ctor*"></a>
  <h4 id="alps__net_api_GenericReturnToOriginReference__ctor" data-uid="alps_.net_api.GenericReturnToOriginReference.#ctor">GenericReturnToOriginReference()</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new empty instance of the generic return to origin reference class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public GenericReturnToOriginReference()</code></pre>
  </div>
  
  
  <a id="alps__net_api_GenericReturnToOriginReference__ctor_" data-uid="alps_.net_api.GenericReturnToOriginReference.#ctor*"></a>
  <h4 id="alps__net_api_GenericReturnToOriginReference__ctor_System_Collections_Generic_List_System_String__System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_alps__net_api_Transition_alps__net_api_Transition_alps__net_api_FunctionSpecification_alps__net_api_GuardBehavior_alps__net_api_Action_alps__net_api_Action_" data-uid="alps_.net_api.GenericReturnToOriginReference.#ctor(System.Collections.Generic.List{System.String},System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,alps_.net_api.Transition,alps_.net_api.Transition,alps_.net_api.FunctionSpecification,alps_.net_api.GuardBehavior,alps_.net_api.Action,alps_.net_api.Action)">GenericReturnToOriginReference(List&lt;String&gt;, String, List&lt;String&gt;, String, SubjectBehavior, Transition, Transition, FunctionSpecification, GuardBehavior, Action, Action)</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new fully specified instance of the generic return to origin reference class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public GenericReturnToOriginReference(List&lt;string&gt; additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action, Action belongsToaction)</code></pre>
  </div>
  ...
  <h4 id="alps__net_api_GenericReturnToOriginReference_className" data-uid="alps_.net_api.GenericReturnToOriginReference.className">className</h4>
  <div class="markdown level1 summary"><p>Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;GenericReturnToOriginReference&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_GenericReturnToOriginReference_factoryMethod_" data-uid="alps_.net_api.GenericReturnToOriginReference.factoryMethod*"></a>
  <h4 id="alps__net_api_GenericReturnToOriginReference_factoryMethod" data-uid="alps_.net_api.GenericReturnToOriginReference.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p>Factory method that creates and returns a new empty instance of the generic return to origin reference class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public GenericReturnToOriginReference factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.GenericReturnToOriginReference.html">GenericReturnToOriginReference</a></td>
        <td><p>A new empty instance of the generic return to origin reference class</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_GenericReturnToOriginReference_getBelongsToAction_" data-uid="alps_.net_api.GenericReturnToOriginReference.getBelongsToAction*"></a>
  <h4 id="alps__net_api_GenericReturnToOriginReference_getBelongsToAction" data-uid="alps_.net_api.GenericReturnToOriginReference.getBelongsToAction">getBelongsToAction()</h4>
  ...
  <a id="alps__net_api_GenericReturnToOriginReference_getTmpBelongsToAction_" data-uid="alps_.net_api.GenericReturnToOriginReference.getTmpBelongsToAction*"></a>
  <h4 id="alps__net_api_GenericReturnToOriginReference_getTmpBelongsToAction" data-uid="alps_.net_api.GenericReturnToOriginReference.getTmpBelongsToAction">getTmpBelongsToAction()</h4>
  ...
  <a id="alps__net_api_GenericReturnToOriginReference_setBelongsToAction_" data-uid="alps_.net_api.GenericReturnToOriginReference.setBelongsToAction*"></a>
  <h4 id="alps__net_api_GenericReturnToOriginReference_setBelongsToAction_alps__net_api_IAction_" data-uid="alps_.net_api.GenericReturnToOriginReference.setBelongsToAction(alps_.net_api.IAction)">setBelongsToAction(IAction)</h4>
  ...
  <div>
      <a class="xref" href="alps_.net_api.IGenericReturnToOriginRefrence.html">IGenericReturnToOriginRefrence</a>
  </div>
  <div>
