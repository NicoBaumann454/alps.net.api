...
<html>
  ...
  <div class="markdown level0 summary"><p sourcefile="obj/api/alps_.net_api.SendFunction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Class that represents a send function</p>
</div>
  ...
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.SendFunction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new empty instance of the send function class</p>
</div>
  ...
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.SendFunction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new fully specified instance of the send function class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <h4 id="alps__net_api_SendFunction_className" data-uid="alps_.net_api.SendFunction.className">className</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.SendFunction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;SendFunction&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_SendFunction_factoryMethod_" data-uid="alps_.net_api.SendFunction.factoryMethod*"></a>
  <h4 id="alps__net_api_SendFunction_factoryMethod" data-uid="alps_.net_api.SendFunction.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.SendFunction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Factory method that creates and returns a new empty instance of the send function class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public SendFunction factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.SendFunction.html">SendFunction</a></td>
        <td><p sourcefile="obj/api/alps_.net_api.SendFunction.yml" sourcestartlinenumber="1" sourceendlinenumber="1">A new empty instance of the send function class</p>
</td>
      </tr>
    </tbody>
  </table>
