...
<html>
  ...
  <head>
    ...
    <title>Interface IReceiveFunction
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface IReceiveFunction
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.IReceiveFunction">
  
  
  <h1 id="alps__net_api_IReceiveFunction" data-uid="alps_.net_api.IReceiveFunction" class="text-break">Interface IReceiveFunction
  </h1>
  <div class="markdown level0 summary"><p>Interface of the receive function class</p>
</div>
  <div class="markdown level0 conceptual"></div>
  <div class="inheritedMembers">
    <h5>Inherited Members</h5>
    <div>
      <a class="xref" href="alps_.net_api.IFunctionSpecification.html#alps__net_api_IFunctionSpecification_setToolSpecificDefinition_System_String_">IFunctionSpecification.setToolSpecificDefinition(String)</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.IFunctionSpecification.html#alps__net_api_IFunctionSpecification_getToolSpecificDefinition">IFunctionSpecification.getToolSpecificDefinition()</a>
    </div>
    <div>
  ...
  <h5 id="alps__net_api_IReceiveFunction_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IReceiveFunction : ICommunicationAct, IFunctionSpecification, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="methods">Methods
  </h3>
  
  
  <a id="alps__net_api_IReceiveFunction_factoryMethod_" data-uid="alps_.net_api.IReceiveFunction.factoryMethod*"></a>
  <h4 id="alps__net_api_IReceiveFunction_factoryMethod" data-uid="alps_.net_api.IReceiveFunction.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p>Factory method that creates and returns a new empty instance of the receive function class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">ReceiveFunction factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>A new empty instance of the receive function class</p>
</td>
      </tr>
    </tbody>
  </table>
