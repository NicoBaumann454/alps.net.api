...
<html>
  ...
  <a id="alps__net_api_SendState__ctor_" data-uid="alps_.net_api.SendState.#ctor*"></a>
  <h4 id="alps__net_api_SendState__ctor_System_String_System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_alps__net_api_Transition_alps__net_api_Transition_alps__net_api_FunctionSpecification_alps__net_api_GuardBehavior_alps__net_api_Action_alps__net_api_ReceiveFunction_alps__net_api_SendTransition_alps__net_api_SendingFailedTransition_" data-uid="alps_.net_api.SendState.#ctor(System.String,System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,alps_.net_api.Transition,alps_.net_api.Transition,alps_.net_api.FunctionSpecification,alps_.net_api.GuardBehavior,alps_.net_api.Action,alps_.net_api.ReceiveFunction,alps_.net_api.SendTransition,alps_.net_api.SendingFailedTransition)">SendState(String, String, List&lt;String&gt;, String, SubjectBehavior, Transition, Transition, FunctionSpecification, GuardBehavior, Action, ReceiveFunction, SendTransition, SendingFailedTransition)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public SendState(string additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action, ReceiveFunction receiveFunction, SendTransition sendTransition, SendingFailedTransition sendingFailedTransition)</code></pre>
  </div>
