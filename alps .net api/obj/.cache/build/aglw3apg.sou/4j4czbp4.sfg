...
<html>
  ...
  <head>
    ...
    <title>Class EndState
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class EndState
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.EndState">
  
  
  <h1 id="alps__net_api_EndState" data-uid="alps_.net_api.EndState" class="text-break">Class EndState
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/alps_.net_api.EndState.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Class that represents an EndState</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><span class="xref">EndState</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="alps_.net_api.IEndState.html">IEndState</a></div>
  ...
  <h5 id="alps__net_api_EndState_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class EndState : State, IEndState, IState, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_EndState__ctor_" data-uid="alps_.net_api.EndState.#ctor*"></a>
  <h4 id="alps__net_api_EndState__ctor" data-uid="alps_.net_api.EndState.#ctor">EndState()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.EndState.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new empty instance of the end state class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public EndState()</code></pre>
  </div>
  
  
  <a id="alps__net_api_EndState__ctor_" data-uid="alps_.net_api.EndState.#ctor*"></a>
  <h4 id="alps__net_api_EndState__ctor_System_Collections_Generic_List_System_String__System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_alps__net_api_Transition_alps__net_api_Transition_alps__net_api_FunctionSpecification_alps__net_api_GuardBehavior_alps__net_api_Action_alps__net_api_Action_" data-uid="alps_.net_api.EndState.#ctor(System.Collections.Generic.List{System.String},System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,alps_.net_api.Transition,alps_.net_api.Transition,alps_.net_api.FunctionSpecification,alps_.net_api.GuardBehavior,alps_.net_api.Action,alps_.net_api.Action)">EndState(List&lt;String&gt;, String, List&lt;String&gt;, String, SubjectBehavior, Transition, Transition, FunctionSpecification, GuardBehavior, Action, Action)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.EndState.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new fully specified instance of the end state class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public EndState(List&lt;string&gt; additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action, Action belongsToaction)</code></pre>
  </div>
  ...
  <h4 id="alps__net_api_EndState_className" data-uid="alps_.net_api.EndState.className">className</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.EndState.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;EndState&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_EndState_createInstance_" data-uid="alps_.net_api.EndState.createInstance*"></a>
  <h4 id="alps__net_api_EndState_createInstance_System_Collections_Generic_List_System_String__System_Collections_Generic_List_System_String__" data-uid="alps_.net_api.EndState.createInstance(System.Collections.Generic.List{System.String},System.Collections.Generic.List{System.String})">createInstance(List&lt;String&gt;, List&lt;String&gt;)</h4>
  ...
  <a id="alps__net_api_EndState_factoryMethod_" data-uid="alps_.net_api.EndState.factoryMethod*"></a>
  <h4 id="alps__net_api_EndState_factoryMethod" data-uid="alps_.net_api.EndState.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.EndState.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Factory method that creates and returns a new instance of the end state class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public EndState factoryMethod()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="obj/api/alps_.net_api.EndState.yml" sourcestartlinenumber="1" sourceendlinenumber="1">A new instance of the end state class</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_EndState_getBelongsToAction_" data-uid="alps_.net_api.EndState.getBelongsToAction*"></a>
  <h4 id="alps__net_api_EndState_getBelongsToAction" data-uid="alps_.net_api.EndState.getBelongsToAction">getBelongsToAction()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.EndState.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Method that returns the action attribute</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="obj/api/alps_.net_api.EndState.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The action attribute</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_EndState_getTmpBelongsToAction_" data-uid="alps_.net_api.EndState.getTmpBelongsToAction*"></a>
  <h4 id="alps__net_api_EndState_getTmpBelongsToAction" data-uid="alps_.net_api.EndState.getTmpBelongsToAction">getTmpBelongsToAction()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="alps__net_api_EndState_setBelongsToAction_" data-uid="alps_.net_api.EndState.setBelongsToAction*"></a>
  <h4 id="alps__net_api_EndState_setBelongsToAction_alps__net_api_IAction_" data-uid="alps_.net_api.EndState.setBelongsToAction(alps_.net_api.IAction)">setBelongsToAction(IAction)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.EndState.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Method that sets the action attribute</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <div>
      <a class="xref" href="alps_.net_api.IEndState.html">IEndState</a>
  </div>
  <div>
