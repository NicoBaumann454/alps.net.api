...
<html>
  ...
  <head>
    ...
    <title>Class SenderTypeConstraint
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class SenderTypeConstraint
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.SenderTypeConstraint">
  
  
  <h1 id="alps__net_api_SenderTypeConstraint" data-uid="alps_.net_api.SenderTypeConstraint" class="text-break">Class SenderTypeConstraint
  </h1>
  <div class="markdown level0 summary"><p>Class that represents a sender type constraint</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">SenderTypeConstraint</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="alps_.net_api.ISenderTypeConstraint.html">ISenderTypeConstraint</a></div>
  ...
  <h5 id="alps__net_api_SenderTypeConstraint_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class SenderTypeConstraint : InputPoolConstraint, ISenderTypeConstraint, IInputPoolConstraint, IInteractionDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_SenderTypeConstraint__ctor_" data-uid="alps_.net_api.SenderTypeConstraint.#ctor*"></a>
  <h4 id="alps__net_api_SenderTypeConstraint__ctor" data-uid="alps_.net_api.SenderTypeConstraint.#ctor">SenderTypeConstraint()</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new empty instance of the sender type constraint class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public SenderTypeConstraint()</code></pre>
  </div>
  
  
  <a id="alps__net_api_SenderTypeConstraint__ctor_" data-uid="alps_.net_api.SenderTypeConstraint.#ctor*"></a>
  <h4 id="alps__net_api_SenderTypeConstraint__ctor_System_Collections_Generic_List_System_String__System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_InputPoolConstraintHandlingStrategy_System_Int32_alps__net_api_Subject_" data-uid="alps_.net_api.SenderTypeConstraint.#ctor(System.Collections.Generic.List{System.String},System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.InputPoolConstraintHandlingStrategy,System.Int32,alps_.net_api.Subject)">SenderTypeConstraint(List&lt;String&gt;, String, List&lt;String&gt;, String, InputPoolConstraintHandlingStrategy, Int32, Subject)</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new fully specified instance of the sender type constraint class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public SenderTypeConstraint(List&lt;string&gt; additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, InputPoolConstraintHandlingStrategy inputPoolConstraintHandlingStrategy, int limit, Subject subject)</code></pre>
  </div>
  ...
  <h4 id="alps__net_api_SenderTypeConstraint_className" data-uid="alps_.net_api.SenderTypeConstraint.className">className</h4>
  <div class="markdown level1 summary"><p>Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;SenderTypeConstraint&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_SenderTypeConstraint_factoryMethod_" data-uid="alps_.net_api.SenderTypeConstraint.factoryMethod*"></a>
  <h4 id="alps__net_api_SenderTypeConstraint_factoryMethod" data-uid="alps_.net_api.SenderTypeConstraint.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p>Factory method that creates and returns a empty instance of the sender type constraint class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public SenderTypeConstraint factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.SenderTypeConstraint.html">SenderTypeConstraint</a></td>
        <td><p>A empty instance of the sender type constraint class</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_SenderTypeConstraint_getReferenceSubject_" data-uid="alps_.net_api.SenderTypeConstraint.getReferenceSubject*"></a>
  <h4 id="alps__net_api_SenderTypeConstraint_getReferenceSubject" data-uid="alps_.net_api.SenderTypeConstraint.getReferenceSubject">getReferenceSubject()</h4>
  ...
  <a id="alps__net_api_SenderTypeConstraint_getTmpSubject_" data-uid="alps_.net_api.SenderTypeConstraint.getTmpSubject*"></a>
  <h4 id="alps__net_api_SenderTypeConstraint_getTmpSubject" data-uid="alps_.net_api.SenderTypeConstraint.getTmpSubject">getTmpSubject()</h4>
  ...
  <a id="alps__net_api_SenderTypeConstraint_setReferencesSubject_" data-uid="alps_.net_api.SenderTypeConstraint.setReferencesSubject*"></a>
  <h4 id="alps__net_api_SenderTypeConstraint_setReferencesSubject_alps__net_api_ISubject_" data-uid="alps_.net_api.SenderTypeConstraint.setReferencesSubject(alps_.net_api.ISubject)">setReferencesSubject(ISubject)</h4>
  ...
  <div>
      <a class="xref" href="alps_.net_api.ISenderTypeConstraint.html">ISenderTypeConstraint</a>
  </div>
  <div>
