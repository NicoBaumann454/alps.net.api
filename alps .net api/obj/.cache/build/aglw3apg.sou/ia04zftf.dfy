...
<html>
  ...
  <head>
    ...
    <title>Class ReceiveFunction
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class ReceiveFunction
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.ReceiveFunction">
  
  
  <h1 id="alps__net_api_ReceiveFunction" data-uid="alps_.net_api.ReceiveFunction" class="text-break">Class ReceiveFunction
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/alps_.net_api.ReceiveFunction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Class that represents a receive function class</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">ReceiveFunction</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="alps_.net_api.IReceiveFunction.html">IReceiveFunction</a></div>
  ...
  <h5 id="alps__net_api_ReceiveFunction_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class ReceiveFunction : CommunicationAct, IReceiveFunction, ICommunicationAct, IFunctionSpecification, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_ReceiveFunction__ctor_" data-uid="alps_.net_api.ReceiveFunction.#ctor*"></a>
  <h4 id="alps__net_api_ReceiveFunction__ctor" data-uid="alps_.net_api.ReceiveFunction.#ctor">ReceiveFunction()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.ReceiveFunction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new empty instance of the receive function class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public ReceiveFunction()</code></pre>
  </div>
  
  
  <a id="alps__net_api_ReceiveFunction__ctor_" data-uid="alps_.net_api.ReceiveFunction.#ctor*"></a>
  <h4 id="alps__net_api_ReceiveFunction__ctor_System_Collections_Generic_List_System_String__System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_System_String_" data-uid="alps_.net_api.ReceiveFunction.#ctor(System.Collections.Generic.List{System.String},System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,System.String)">ReceiveFunction(List&lt;String&gt;, String, List&lt;String&gt;, String, SubjectBehavior, String)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.ReceiveFunction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new fully specified instance of the receive function class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public ReceiveFunction(List&lt;string&gt; additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, string toolSpecificDefinition)</code></pre>
  </div>
  ...
  <h4 id="alps__net_api_ReceiveFunction_className" data-uid="alps_.net_api.ReceiveFunction.className">className</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.ReceiveFunction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;ReceiveFunction&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_ReceiveFunction_factoryMethod_" data-uid="alps_.net_api.ReceiveFunction.factoryMethod*"></a>
  <h4 id="alps__net_api_ReceiveFunction_factoryMethod" data-uid="alps_.net_api.ReceiveFunction.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.ReceiveFunction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Factory method that creates and returns a new empty instance of the receive function class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public ReceiveFunction factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="obj/api/alps_.net_api.ReceiveFunction.yml" sourcestartlinenumber="1" sourceendlinenumber="1">A new empty instance of the receive function class</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <div>
      <a class="xref" href="alps_.net_api.IReceiveFunction.html">IReceiveFunction</a>
  </div>
  <div>
