...
<html>
  ...
  <head>
    ...
    <title>Class StateReference
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class StateReference
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.StateReference">
  
  
  <h1 id="alps__net_api_StateReference" data-uid="alps_.net_api.StateReference" class="text-break">Class StateReference
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/alps_.net_api.StateReference.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Class that represents a state reference class</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><span class="xref">StateReference</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="alps_.net_api.IStateReference.html">IStateReference</a></div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="alps_.net_api.State.html#alps__net_api_State_getTmpIncomingTransition">State.getTmpIncomingTransition()</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.State.html#alps__net_api_State_getTmpOutgoingTransition">State.getTmpOutgoingTransition()</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.State.html#alps__net_api_State_getTmpFunctionSpecification">State.getTmpFunctionSpecification()</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.State.html#alps__net_api_State_getTmpGuardBehavior">State.getTmpGuardBehavior()</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.State.html#alps__net_api_State_getTmpAction">State.getTmpAction()</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.State.html#alps__net_api_State_createInstance_System_Collections_Generic_List_System_String__System_Collections_Generic_List_System_String__">State.createInstance(List&lt;String&gt;, List&lt;String&gt;)</a>
    </div>
    <div>
  ...
  <h5 id="alps__net_api_StateReference_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class StateReference : State, IStateReference, IState, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_StateReference__ctor_" data-uid="alps_.net_api.StateReference.#ctor*"></a>
  <h4 id="alps__net_api_StateReference__ctor" data-uid="alps_.net_api.StateReference.#ctor">StateReference()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.StateReference.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new empty instance of the state refrence class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public StateReference()</code></pre>
  </div>
  
  
  <a id="alps__net_api_StateReference__ctor_" data-uid="alps_.net_api.StateReference.#ctor*"></a>
  <h4 id="alps__net_api_StateReference__ctor_System_Collections_Generic_List_System_String__System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_alps__net_api_Transition_alps__net_api_Transition_alps__net_api_FunctionSpecification_alps__net_api_GuardBehavior_alps__net_api_Action_alps__net_api_State_" data-uid="alps_.net_api.StateReference.#ctor(System.Collections.Generic.List{System.String},System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,alps_.net_api.Transition,alps_.net_api.Transition,alps_.net_api.FunctionSpecification,alps_.net_api.GuardBehavior,alps_.net_api.Action,alps_.net_api.State)">StateReference(List&lt;String&gt;, String, List&lt;String&gt;, String, SubjectBehavior, Transition, Transition, FunctionSpecification, GuardBehavior, Action, State)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.StateReference.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new fully specified instance of the state refrence class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public StateReference(List&lt;string&gt; additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action, State referenceState)</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><span class="parametername">referenceState</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <h4 id="alps__net_api_StateReference_className" data-uid="alps_.net_api.StateReference.className">className</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.StateReference.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;StateReference&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_StateReference_factoryMethod_" data-uid="alps_.net_api.StateReference.factoryMethod*"></a>
  <h4 id="alps__net_api_StateReference_factoryMethod" data-uid="alps_.net_api.StateReference.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.StateReference.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Factory method that creates and returns a new empty instance of the state reference class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public StateReference factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.StateReference.html">StateReference</a></td>
        <td><p sourcefile="obj/api/alps_.net_api.StateReference.yml" sourcestartlinenumber="1" sourceendlinenumber="1">A new empty instance of the state reference class</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_StateReference_getReferencesState_" data-uid="alps_.net_api.StateReference.getReferencesState*"></a>
  <h4 id="alps__net_api_StateReference_getReferencesState" data-uid="alps_.net_api.StateReference.getReferencesState">getReferencesState()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.StateReference.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Method that returns the state attribute of the instance</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public IState getReferencesState()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="obj/api/alps_.net_api.StateReference.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The state attribute of the instance</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_StateReference_getTmpReferenceState_" data-uid="alps_.net_api.StateReference.getTmpReferenceState*"></a>
  <h4 id="alps__net_api_StateReference_getTmpReferenceState" data-uid="alps_.net_api.StateReference.getTmpReferenceState">getTmpReferenceState()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string getTmpReferenceState()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="alps__net_api_StateReference_setReferencesState_" data-uid="alps_.net_api.StateReference.setReferencesState*"></a>
  <h4 id="alps__net_api_StateReference_setReferencesState_alps__net_api_IState_" data-uid="alps_.net_api.StateReference.setReferencesState(alps_.net_api.IState)">setReferencesState(IState)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.StateReference.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Method that sets the state attribute of the instance</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public void setReferencesState(IState state)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <div>
      <a class="xref" href="alps_.net_api.IStateReference.html">IStateReference</a>
  </div>
  <div>
