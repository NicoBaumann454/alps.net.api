...
<html>
  ...
  <head>
    ...
    <title>Interface IInitialStateOfBehavior
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface IInitialStateOfBehavior
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.IInitialStateOfBehavior">
  
  
  <h1 id="alps__net_api_IInitialStateOfBehavior" data-uid="alps_.net_api.IInitialStateOfBehavior" class="text-break">Interface IInitialStateOfBehavior
  </h1>
  <div class="markdown level0 summary"><p>Interface to the InitialStateOfBehavior class</p>
</div>
  ...
  <h5 id="alps__net_api_IInitialStateOfBehavior_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IInitialStateOfBehavior : IState, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="methods">Methods
  </h3>
  
  
  <a id="alps__net_api_IInitialStateOfBehavior_factoryMethod_" data-uid="alps_.net_api.IInitialStateOfBehavior.factoryMethod*"></a>
  <h4 id="alps__net_api_IInitialStateOfBehavior_factoryMethod" data-uid="alps_.net_api.IInitialStateOfBehavior.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">InitialStateOfBehavior factoryMethod()</code></pre>
  </div>
  ...
  <a id="alps__net_api_IInitialStateOfBehavior_getBelongsToAction_" data-uid="alps_.net_api.IInitialStateOfBehavior.getBelongsToAction*"></a>
  <h4 id="alps__net_api_IInitialStateOfBehavior_getBelongsToAction" data-uid="alps_.net_api.IInitialStateOfBehavior.getBelongsToAction">getBelongsToAction()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="alps__net_api_IInitialStateOfBehavior_setBelongsToAction_" data-uid="alps_.net_api.IInitialStateOfBehavior.setBelongsToAction*"></a>
  <h4 id="alps__net_api_IInitialStateOfBehavior_setBelongsToAction_alps__net_api_IAction_" data-uid="alps_.net_api.IInitialStateOfBehavior.setBelongsToAction(alps_.net_api.IAction)">setBelongsToAction(IAction)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
