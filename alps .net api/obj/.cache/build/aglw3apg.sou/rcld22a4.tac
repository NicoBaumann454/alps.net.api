...
<html>
  ...
  <head>
    ...
    <title>Class OWLDataTypeDefintion
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class OWLDataTypeDefintion
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.OWLDataTypeDefintion">
  
  
  <h1 id="alps__net_api_OWLDataTypeDefintion" data-uid="alps_.net_api.OWLDataTypeDefintion" class="text-break">Class OWLDataTypeDefintion
  </h1>
  <div class="markdown level0 summary"><p>Class that represents a OWL data type definition</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><a class="xref" href="alps_.net_api.DataDescribingComponent.html">DataDescribingComponent</a></div>
    <div class="level4"><a class="xref" href="alps_.net_api.DataTypeDefintion.html">DataTypeDefintion</a></div>
    <div class="level5"><a class="xref" href="alps_.net_api.CustomOrExternalDataTypeDefintion.html">CustomOrExternalDataTypeDefintion</a></div>
    <div class="level6"><span class="xref">OWLDataTypeDefintion</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="alps_.net_api.IOWLDataTypeDefintion.html">IOWLDataTypeDefintion</a></div>
    <div><a class="xref" href="alps_.net_api.ICustomOrExternalDataTypeDefintion.html">ICustomOrExternalDataTypeDefintion</a></div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="alps_.net_api.DataTypeDefintion.html#alps__net_api_DataTypeDefintion_setContainsDataObjectDefintion_alps__net_api_IDataObjectDefiniton_">DataTypeDefintion.setContainsDataObjectDefintion(IDataObjectDefiniton)</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.DataTypeDefintion.html#alps__net_api_DataTypeDefintion_getDataObjectDefiniton">DataTypeDefintion.getDataObjectDefiniton()</a>
    </div>
    <div>
      <a class="xref" href="alps_.net_api.DataTypeDefintion.html#alps__net_api_DataTypeDefintion_getTmpDataObjectDefinition">DataTypeDefintion.getTmpDataObjectDefinition()</a>
    </div>
    <div>
  ...
  <h5 id="alps__net_api_OWLDataTypeDefintion_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class OWLDataTypeDefintion : CustomOrExternalDataTypeDefintion, IOWLDataTypeDefintion, ICustomOrExternalDataTypeDefintion, IDataTypeDefintion, IDataDescribingComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_OWLDataTypeDefintion__ctor_" data-uid="alps_.net_api.OWLDataTypeDefintion.#ctor*"></a>
  <h4 id="alps__net_api_OWLDataTypeDefintion__ctor" data-uid="alps_.net_api.OWLDataTypeDefintion.#ctor">OWLDataTypeDefintion()</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new empty instance of the OWL data type definition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public OWLDataTypeDefintion()</code></pre>
  </div>
  
  
  <a id="alps__net_api_OWLDataTypeDefintion__ctor_" data-uid="alps_.net_api.OWLDataTypeDefintion.#ctor*"></a>
  <h4 id="alps__net_api_OWLDataTypeDefintion__ctor_System_Collections_Generic_List_System_String__System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_DataObjectDefiniton_" data-uid="alps_.net_api.OWLDataTypeDefintion.#ctor(System.Collections.Generic.List{System.String},System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.DataObjectDefiniton)">OWLDataTypeDefintion(List&lt;String&gt;, String, List&lt;String&gt;, String, DataObjectDefiniton)</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new fully specified instance of the OWL data type definition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public OWLDataTypeDefintion(List&lt;string&gt; additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, DataObjectDefiniton dataObjectDefiniton)</code></pre>
  </div>
  ...
  <h4 id="alps__net_api_OWLDataTypeDefintion_className" data-uid="alps_.net_api.OWLDataTypeDefintion.className">className</h4>
  <div class="markdown level1 summary"><p>Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;OWLDataTypeDefintion&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_OWLDataTypeDefintion_factoryMethod_" data-uid="alps_.net_api.OWLDataTypeDefintion.factoryMethod*"></a>
  <h4 id="alps__net_api_OWLDataTypeDefintion_factoryMethod" data-uid="alps_.net_api.OWLDataTypeDefintion.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p>Factory method that creates and returns a new empty instance of the OWL data type definition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public OWLDataTypeDefintion factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.OWLDataTypeDefintion.html">OWLDataTypeDefintion</a></td>
        <td><p>A new empty instance of the OWL data type definition class</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <div>
      <a class="xref" href="alps_.net_api.IOWLDataTypeDefintion.html">IOWLDataTypeDefintion</a>
  </div>
  <div>
      <a class="xref" href="alps_.net_api.ICustomOrExternalDataTypeDefintion.html">ICustomOrExternalDataTypeDefintion</a>
  </div>
  <div>
