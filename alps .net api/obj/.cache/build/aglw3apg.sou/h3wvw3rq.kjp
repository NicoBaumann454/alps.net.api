...
<html>
  ...
  <head>
    ...
    <title>Interface IInputPoolConstraintHandlingStrategy
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface IInputPoolConstraintHandlingStrategy
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.IInputPoolConstraintHandlingStrategy">
  
  
  <h1 id="alps__net_api_IInputPoolConstraintHandlingStrategy" data-uid="alps_.net_api.IInputPoolConstraintHandlingStrategy" class="text-break">Interface IInputPoolConstraintHandlingStrategy
  </h1>
  <div class="markdown level0 summary"><p>Interface to the InputPoolConstraintHandlingStrategyClass</p>
</div>
  ...
  <h5 id="alps__net_api_IInputPoolConstraintHandlingStrategy_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IInputPoolConstraintHandlingStrategy : IInteractionDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="methods">Methods
  </h3>
  
  
  <a id="alps__net_api_IInputPoolConstraintHandlingStrategy_factoryMethod_" data-uid="alps_.net_api.IInputPoolConstraintHandlingStrategy.factoryMethod*"></a>
  <h4 id="alps__net_api_IInputPoolConstraintHandlingStrategy_factoryMethod" data-uid="alps_.net_api.IInputPoolConstraintHandlingStrategy.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">InputPoolConstraintHandlingStrategy factoryMethod()</code></pre>
  </div>
