...
<html>
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.IAction">
  
  
  <h1 id="alps__net_api_IAction" data-uid="alps_.net_api.IAction" class="text-break">Interface IAction
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/alps_.net_api.IAction.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Interface to the Action class</p>
</div>
  ...
  <h5 id="alps__net_api_IAction_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IAction : IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="methods">Methods
  </h3>
  
  
  <a id="alps__net_api_IAction_factoryMethod_" data-uid="alps_.net_api.IAction.factoryMethod*"></a>
  <h4 id="alps__net_api_IAction_factoryMethod" data-uid="alps_.net_api.IAction.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">Action factoryMethod()</code></pre>
  </div>
  ...
  <a id="alps__net_api_IAction_getState_" data-uid="alps_.net_api.IAction.getState*"></a>
  <h4 id="alps__net_api_IAction_getState" data-uid="alps_.net_api.IAction.getState">getState()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">IState getState()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="alps__net_api_IAction_getTransition_" data-uid="alps_.net_api.IAction.getTransition*"></a>
  <h4 id="alps__net_api_IAction_getTransition" data-uid="alps_.net_api.IAction.getTransition">getTransition()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">ITransition getTransition()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.ITransition.html">ITransition</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_IAction_setContainsState_" data-uid="alps_.net_api.IAction.setContainsState*"></a>
  <h4 id="alps__net_api_IAction_setContainsState_alps__net_api_IState_" data-uid="alps_.net_api.IAction.setContainsState(alps_.net_api.IState)">setContainsState(IState)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">void setContainsState(IState state)</code></pre>
  </div>
  ...
  <a id="alps__net_api_IAction_setContainsTransition_" data-uid="alps_.net_api.IAction.setContainsTransition*"></a>
  <h4 id="alps__net_api_IAction_setContainsTransition_alps__net_api_ITransition_" data-uid="alps_.net_api.IAction.setContainsTransition(alps_.net_api.ITransition)">setContainsTransition(ITransition)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">void setContainsTransition(ITransition transition)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
