...
<html>
  ...
  <head>
    ...
    <title>Class MessageTypeConstraint
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class MessageTypeConstraint
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.MessageTypeConstraint">
  
  
  <h1 id="alps__net_api_MessageTypeConstraint" data-uid="alps_.net_api.MessageTypeConstraint" class="text-break">Class MessageTypeConstraint
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/alps_.net_api.MessageTypeConstraint.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Class that represents a message type constraint</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">MessageTypeConstraint</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="alps_.net_api.IMessageTypeConstraint.html">IMessageTypeConstraint</a></div>
  ...
  <h5 id="alps__net_api_MessageTypeConstraint_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class MessageTypeConstraint : InputPoolConstraint, IMessageTypeConstraint, IInputPoolConstraint, IInteractionDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_MessageTypeConstraint__ctor_" data-uid="alps_.net_api.MessageTypeConstraint.#ctor*"></a>
  <h4 id="alps__net_api_MessageTypeConstraint__ctor" data-uid="alps_.net_api.MessageTypeConstraint.#ctor">MessageTypeConstraint()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.MessageTypeConstraint.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new empty instance of the message type constraint class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public MessageTypeConstraint()</code></pre>
  </div>
  
  
  <a id="alps__net_api_MessageTypeConstraint__ctor_" data-uid="alps_.net_api.MessageTypeConstraint.#ctor*"></a>
  <h4 id="alps__net_api_MessageTypeConstraint__ctor_System_Collections_Generic_List_System_String__System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_InputPoolConstraintHandlingStrategy_System_Int32_alps__net_api_MessageSpecification_" data-uid="alps_.net_api.MessageTypeConstraint.#ctor(System.Collections.Generic.List{System.String},System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.InputPoolConstraintHandlingStrategy,System.Int32,alps_.net_api.MessageSpecification)">MessageTypeConstraint(List&lt;String&gt;, String, List&lt;String&gt;, String, InputPoolConstraintHandlingStrategy, Int32, MessageSpecification)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.MessageTypeConstraint.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new fully specified instance of the message type constraint class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public MessageTypeConstraint(List&lt;string&gt; additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, InputPoolConstraintHandlingStrategy inputPoolConstraintHandlingStrategy, int limit, MessageSpecification messageSpecification)</code></pre>
  </div>
  ...
  <h4 id="alps__net_api_MessageTypeConstraint_className" data-uid="alps_.net_api.MessageTypeConstraint.className">className</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.MessageTypeConstraint.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;MessageTypeConstraint&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_MessageTypeConstraint_factoryMethod_" data-uid="alps_.net_api.MessageTypeConstraint.factoryMethod*"></a>
  <h4 id="alps__net_api_MessageTypeConstraint_factoryMethod" data-uid="alps_.net_api.MessageTypeConstraint.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.MessageTypeConstraint.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Factory method that creates and returns a new empty instance of the message type constraint class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public MessageTypeConstraint factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.MessageTypeConstraint.html">MessageTypeConstraint</a></td>
        <td><p sourcefile="obj/api/alps_.net_api.MessageTypeConstraint.yml" sourcestartlinenumber="1" sourceendlinenumber="1">A new empty instance of the message type constraint class</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_MessageTypeConstraint_getMessageSpecification_" data-uid="alps_.net_api.MessageTypeConstraint.getMessageSpecification*"></a>
  <h4 id="alps__net_api_MessageTypeConstraint_getMessageSpecification" data-uid="alps_.net_api.MessageTypeConstraint.getMessageSpecification">getMessageSpecification()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.MessageTypeConstraint.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Method that returns the message specification attribute of the instance</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="obj/api/alps_.net_api.MessageTypeConstraint.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The message specification attribute of the instance</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_MessageTypeConstraint_getTmpMessageSpecification_" data-uid="alps_.net_api.MessageTypeConstraint.getTmpMessageSpecification*"></a>
  <h4 id="alps__net_api_MessageTypeConstraint_getTmpMessageSpecification" data-uid="alps_.net_api.MessageTypeConstraint.getTmpMessageSpecification">getTmpMessageSpecification()</h4>
  ...
  <a id="alps__net_api_MessageTypeConstraint_setReferncesMessageSpecification_" data-uid="alps_.net_api.MessageTypeConstraint.setReferncesMessageSpecification*"></a>
  <h4 id="alps__net_api_MessageTypeConstraint_setReferncesMessageSpecification_alps__net_api_IMessageSpecification_" data-uid="alps_.net_api.MessageTypeConstraint.setReferncesMessageSpecification(alps_.net_api.IMessageSpecification)">setReferncesMessageSpecification(IMessageSpecification)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.MessageTypeConstraint.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Method that sets the message specification attribute of the instance</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <div>
      <a class="xref" href="alps_.net_api.IMessageTypeConstraint.html">IMessageTypeConstraint</a>
  </div>
  <div>
