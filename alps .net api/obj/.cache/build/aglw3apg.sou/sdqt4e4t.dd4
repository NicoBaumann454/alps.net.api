...
<html>
  ...
  <div class="markdown level0 summary"><p>Class that represents a time based reminder transition</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><span class="xref">TimeBasedReminderTransition</span></div>
  </div>
  ...
  <div class="markdown level1 summary"><p>Constructor that creates a new empty instance of the time based reminder transition</p>
</div>
  ...
  <a id="alps__net_api_TimeBasedReminderTransition__ctor_" data-uid="alps_.net_api.TimeBasedReminderTransition.#ctor*"></a>
  <h4 id="alps__net_api_TimeBasedReminderTransition__ctor_System_String_System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_alps__net_api_Action_alps__net_api_State_alps__net_api_State_alps__net_api_TransitionCondition_" data-uid="alps_.net_api.TimeBasedReminderTransition.#ctor(System.String,System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,alps_.net_api.Action,alps_.net_api.State,alps_.net_api.State,alps_.net_api.TransitionCondition)">TimeBasedReminderTransition(String, String, List&lt;String&gt;, String, SubjectBehavior, Action, State, State, TransitionCondition)</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new fully specified instance of the time based reminder transition</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public TimeBasedReminderTransition(string additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition)</code></pre>
  </div>
  ...
  <div class="markdown level1 summary"><p>Factory method that creates and returns a new empty instance of the time based reminder transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>A new empty instance of the time based reminder transition class</p>
</td>
      </tr>
    </tbody>
  </table>
