...
<html>
  ...
  <head>
    ...
    <title>Class DoTransition
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class DoTransition
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.DoTransition">
  
  
  <h1 id="alps__net_api_DoTransition" data-uid="alps_.net_api.DoTransition" class="text-break">Class DoTransition
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/alps_.net_api.DoTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Class that represents a DoTransition</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><span class="xref">DoTransition</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="alps_.net_api.IDoTransition.html">IDoTransition</a></div>
  ...
  <h5 id="alps__net_api_DoTransition_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class DoTransition : Transition, IDoTransition, ITransition, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_DoTransition__ctor_" data-uid="alps_.net_api.DoTransition.#ctor*"></a>
  <h4 id="alps__net_api_DoTransition__ctor" data-uid="alps_.net_api.DoTransition.#ctor">DoTransition()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.DoTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new empty instance of the do transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DoTransition()</code></pre>
  </div>
  
  
  <a id="alps__net_api_DoTransition__ctor_" data-uid="alps_.net_api.DoTransition.#ctor*"></a>
  <h4 id="alps__net_api_DoTransition__ctor_System_Collections_Generic_List_System_String__System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_alps__net_api_Action_alps__net_api_State_alps__net_api_State_alps__net_api_TransitionCondition_System_Int32_" data-uid="alps_.net_api.DoTransition.#ctor(System.Collections.Generic.List{System.String},System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,alps_.net_api.Action,alps_.net_api.State,alps_.net_api.State,alps_.net_api.TransitionCondition,System.Int32)">DoTransition(List&lt;String&gt;, String, List&lt;String&gt;, String, SubjectBehavior, Action, State, State, TransitionCondition, Int32)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.DoTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Constructor that creates a new fully specified instance of the do transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DoTransition(List&lt;string&gt; additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition, int nonNegativInteger)</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><span class="parametername">nonNegativInteger</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <h4 id="alps__net_api_DoTransition_className" data-uid="alps_.net_api.DoTransition.className">className</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.DoTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;DoTransition&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_DoTransition_createInstance_" data-uid="alps_.net_api.DoTransition.createInstance*"></a>
  <h4 id="alps__net_api_DoTransition_createInstance_System_Collections_Generic_List_System_String__System_Collections_Generic_List_System_String__" data-uid="alps_.net_api.DoTransition.createInstance(System.Collections.Generic.List{System.String},System.Collections.Generic.List{System.String})">createInstance(List&lt;String&gt;, List&lt;String&gt;)</h4>
  ...
  <a id="alps__net_api_DoTransition_factoryMethod_" data-uid="alps_.net_api.DoTransition.factoryMethod*"></a>
  <h4 id="alps__net_api_DoTransition_factoryMethod" data-uid="alps_.net_api.DoTransition.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.DoTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Factory method that creates and returns a new empty instance of the do transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DoTransition factoryMethod()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.DoTransition.html">DoTransition</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_DoTransition_getPriorityNumber_" data-uid="alps_.net_api.DoTransition.getPriorityNumber*"></a>
  <h4 id="alps__net_api_DoTransition_getPriorityNumber" data-uid="alps_.net_api.DoTransition.getPriorityNumber">getPriorityNumber()</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.DoTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Method that returns the priority number attribute</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public int getPriorityNumber()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Int32</span></td>
        <td><p sourcefile="obj/api/alps_.net_api.DoTransition.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The priority number attribute</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="alps__net_api_DoTransition_setPriorityNumber_" data-uid="alps_.net_api.DoTransition.setPriorityNumber*"></a>
  <h4 id="alps__net_api_DoTransition_setPriorityNumber_System_Int32_" data-uid="alps_.net_api.DoTransition.setPriorityNumber(System.Int32)">setPriorityNumber(Int32)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/alps_.net_api.DoTransition.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Method that sets the priority number attribute</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public void setPriorityNumber(int nonNegativInteger)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <div>
      <a class="xref" href="alps_.net_api.IDoTransition.html">IDoTransition</a>
  </div>
  <div>
