...
<html>
  ...
  <div class="markdown level0 summary"><p>Class that represents an CalenderBasedReminderTransition</p>
</div>
  ...
  <div class="markdown level1 summary"><p>Constructor that creates an empty instance of the Calender Based Reminder Transition class</p>
</div>
  ...
  <a id="alps__net_api_CalenderBasedReminderTransition__ctor_" data-uid="alps_.net_api.CalenderBasedReminderTransition.#ctor*"></a>
  <h4 id="alps__net_api_CalenderBasedReminderTransition__ctor_System_String_System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_alps__net_api_Action_alps__net_api_State_alps__net_api_State_alps__net_api_TransitionCondition_" data-uid="alps_.net_api.CalenderBasedReminderTransition.#ctor(System.String,System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,alps_.net_api.Action,alps_.net_api.State,alps_.net_api.State,alps_.net_api.TransitionCondition)">CalenderBasedReminderTransition(String, String, List&lt;String&gt;, String, SubjectBehavior, Action, State, State, TransitionCondition)</h4>
  <div class="markdown level1 summary"><p>Constructor that creates an fully specified instance of the Calender Based Reminder Transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public CalenderBasedReminderTransition(string additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition)</code></pre>
  </div>
  ...
  <div class="markdown level1 summary"><p>Factory method that creates and returns an empty instance of the Calender Based Reminder Transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>An empty instance of the Calender Based Reminder Transition class</p>
</td>
      </tr>
    </tbody>
  </table>
