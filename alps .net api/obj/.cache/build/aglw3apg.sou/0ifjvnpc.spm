...
<html>
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.IStartSubject">
  
  
  <h1 id="alps__net_api_IStartSubject" data-uid="alps_.net_api.IStartSubject" class="text-break">Interface IStartSubject
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/alps_.net_api.IStartSubject.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Interface to the start subject class</p>
</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="alps_.net_api.IInteractionDescriptionComponent.html#alps__net_api_IInteractionDescriptionComponent_factoryMethod">IInteractionDescriptionComponent.factoryMethod()</a>
    </div>
    <div>
  ...
  <h5 id="alps__net_api_IStartSubject_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IStartSubject : ISubject, IInteractionDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
</article>
          </div>
