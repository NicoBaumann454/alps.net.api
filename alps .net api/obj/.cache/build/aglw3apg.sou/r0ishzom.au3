...
<html>
  ...
  <head>
    ...
    <title>Class DayTimeTimerTransition
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class DayTimeTimerTransition
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="alps_.net_api.DayTimeTimerTransition">
  
  
  <h1 id="alps__net_api_DayTimeTimerTransition" data-uid="alps_.net_api.DayTimeTimerTransition" class="text-break">Class DayTimeTimerTransition
  </h1>
  <div class="markdown level0 summary"><p>Class that represents a DayTimeTimerTransition</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">DayTimeTimerTransition</span></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="alps_.net_api.IDayTimeTimerTransition.html">IDayTimeTimerTransition</a></div>
  ...
  <h5 id="alps__net_api_DayTimeTimerTransition_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class DayTimeTimerTransition : TimeTransition, IDayTimeTimerTransition, ITimerTransition, ITimeTransition, ITransition, IBehaviorDescriptionComponent, IPASSProcessModellElement, IOwlThing</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="alps__net_api_DayTimeTimerTransition__ctor_" data-uid="alps_.net_api.DayTimeTimerTransition.#ctor*"></a>
  <h4 id="alps__net_api_DayTimeTimerTransition__ctor" data-uid="alps_.net_api.DayTimeTimerTransition.#ctor">DayTimeTimerTransition()</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new empty instance of the day time timer transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DayTimeTimerTransition()</code></pre>
  </div>
  
  
  <a id="alps__net_api_DayTimeTimerTransition__ctor_" data-uid="alps_.net_api.DayTimeTimerTransition.#ctor*"></a>
  <h4 id="alps__net_api_DayTimeTimerTransition__ctor_System_String_System_String_System_Collections_Generic_List_System_String__System_String_alps__net_api_SubjectBehavior_alps__net_api_Action_alps__net_api_State_alps__net_api_State_alps__net_api_TransitionCondition_" data-uid="alps_.net_api.DayTimeTimerTransition.#ctor(System.String,System.String,System.Collections.Generic.List{System.String},System.String,alps_.net_api.SubjectBehavior,alps_.net_api.Action,alps_.net_api.State,alps_.net_api.State,alps_.net_api.TransitionCondition)">DayTimeTimerTransition(String, String, List&lt;String&gt;, String, SubjectBehavior, Action, State, State, TransitionCondition)</h4>
  <div class="markdown level1 summary"><p>Constructor that creates a new fully specified instance of the day time timer transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DayTimeTimerTransition(string additionalAttribute, string modelComponentID, List&lt;string&gt; modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition)</code></pre>
  </div>
  ...
  <h4 id="alps__net_api_DayTimeTimerTransition_className" data-uid="alps_.net_api.DayTimeTimerTransition.className">className</h4>
  <div class="markdown level1 summary"><p>Name of the class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public const string className = &quot;DayTimerTransitionCondition&quot;</code></pre>
  </div>
  ...
  <a id="alps__net_api_DayTimeTimerTransition_factoryMethod_" data-uid="alps_.net_api.DayTimeTimerTransition.factoryMethod*"></a>
  <h4 id="alps__net_api_DayTimeTimerTransition_factoryMethod" data-uid="alps_.net_api.DayTimeTimerTransition.factoryMethod">factoryMethod()</h4>
  <div class="markdown level1 summary"><p>Factory method that creates and returns a new empty instance of the day time timer transition class</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DayTimeTimerTransition factoryMethod()</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="alps_.net_api.DayTimeTimerTransition.html">DayTimeTimerTransition</a></td>
        <td><p>A new empty instance of the day time timer transition class</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <div>
      <a class="xref" href="alps_.net_api.IDayTimeTimerTransition.html">IDayTimeTimerTransition</a>
  </div>
  <div>
