...
namespace alps.net_api
{
    ...
    class GuardReceiveState : ReceiveState
    {
        /// <summary>
        /// Name of the class
        /// </summary>
        new public const string className = "GuardReceiveState";

        /// <summary>
        /// Constructor that creates a new empty instance of the guard receive state class
        /// </summary>
        ...
        public GuardReceiveState(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action, ReceiveFunction receiveFunction)
        {
        ...
        /// <summary>
        /// Method that exports an guard receiver state object to the file given in the filename
        /// </summary>
