    ...
    public class InputPoolConstraint : InteractionDescriptionComponent, IInputPoolConstraint
    {
        ...
        public override void export(ref Graph g)
        {
            ...
            if (inputPoolConstraintHandlingStrategy != null)
            {
                ...
                predicate = g.CreateUriNode("rdf:hasInputPoolConstraintHandlingStrategy");
                objec = g.CreateUriNode("standard-pass-ont:" + inputPoolConstraintHandlingStrategy.getModelComponentID());
            ...
            {
                subject = g.CreateUriNode(name);
                predicate = g.CreateUriNode("rdf:hasLimit");
                objec = g.CreateUriNode("standard-pass-ont:" + limit);
