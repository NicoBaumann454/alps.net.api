    ...
    public class SendingFailedTransition : Transition, ISendingFailedTransition
    {
        ...
        public override void export(ref Graph g)
        {
            ...
            if (sendingFailedCondition != null)
            {
                ...
                predicate = g.CreateUriNode("rdf:hasSendingFailedCondition");
                objec = g.CreateUriNode("standard-pass-ont:" + sendingFailedCondition.getModelComponentID());
            ...
            if (this.sourceState != null)
            {
                ...
                objec = g.CreateUriNode("standard-pass-ont:" + this.sourceState.getModelComponentID());
