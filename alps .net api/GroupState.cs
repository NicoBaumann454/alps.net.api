...
{
    class GroupState : AbstractPASSTransition, IGroupState
    {
        ...
        /// <summary>
        /// Constructor that creates a new empty instance of the group state class
        /// </summary>
        public GroupState()
        {
            setModelComponentID("GroupState");
            setComment("The standart Element for GroupState");
        }
        ...
        public GroupState(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action)
        {
        ...
        public override void export(ref Graph g)
        {
            ...
            if (outgoingTransition != null)
            {
                ...
                objec = g.CreateUriNode("standard-pass-ont:" + outgoingTransition.getModelComponentID());
            ...
            if (functionSpecification != null)
            {
                ...
                objec = g.CreateUriNode("standard-pass-ont:" + functionSpecification.getModelComponentID());
        ...
        public override void exporting(bool last, string filename)
        {
            ...
            using (StreamWriter sw = File.AppendText("../../../../" + filename + ".owl"))
            {
                ...
                if (guardBehavior != null)
                {
                    sw.WriteLine("      <standard-pass-ont:guardsBehavior" + " rdf:resource=\"" + guardBehavior.getModelComponentID() + "\" ></standard-pass-ont:guardsBehavior>");
                }
