...
namespace alps.net_api
{
    class FinalTransitionType : AbstractPASSTransition
    {
        ...
        /// Name of the class
        /// </summary>
        new public const string className = "FinalTransitionType";

        /// <summary>
        /// Constructor that creates a new empty instance of the transition class
        /// </summary>
        public FinalTransitionType()
        {
            setModelComponentID("FinalTransitionType");
            setComment("The standart Element for Final Transition Type");
        }
        ...
        public FinalTransitionType(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition)
        {
