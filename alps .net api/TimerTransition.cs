...
namespace alps.net_api
{
    ...
    {
        /// <summary>
        /// Constructor that creates a new empty instance of the timer transition class
        /// </summary>
        public TimerTransition()
        {
            setModelComponentID("TimerTransition");
            setComment("The standart Element for TimerTransition");
        }
        ...
        public TimerTransition(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition)
        {
        ...
        /// <param name="additionalAttribute"></param>
        public TimerTransition(string label, string comment = "", IAction action = null, IState sourceState = null, IState targetState = null, ITransitionCondition transitionCondition = null, transitionType TransitionType = transitionType.Standard, List<string> additionalAttribute = null) : base(label, comment, action, sourceState, targetState, transitionCondition, TransitionType, additionalAttribute)
        {

        }

        /// <summary>
        /// Factory method that creates and returns a new empty instance of the timer transition class
        /// </summary>
        /// <returns>A new empty instance of the timer transition class</returns>
        new public TimerTransition factoryMethod()
        {
        ...
        /// <summary>
        /// Method that creates a new timer transition class
        /// </summary>
