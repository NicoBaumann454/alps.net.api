...
{
    /// <summary>
    /// Class that represents a optional to start choice segment path
    /// </summary>
    public class OptionalToStartChoiceSegmentPath : ChoiceSegmentPath, IOptionalToStartChoiceSegmentPath
    {
        ...
        /// Name of the class
        /// </summary>
        new public const string className = "OptionalToStartChoiceSegmentPath";

        /// <summary>
        /// Constructor that creates a new empty instance of the optional to start choice segment path
        /// </summary>
        public OptionalToStartChoiceSegmentPath()
        {
            setModelComponentID("OptionalToStartChoiceSegmentPath");
            setComment("The standart Element for OptionalToStartChoiceSegmentPath");
        }

        /// <summary>
        /// Constructor that creates a new fully specified instance of the optional to start choice segment path
        /// </summary>
        ...
        public OptionalToStartChoiceSegmentPath(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action, State endState, State initialState, bool optionalToEndChoiceSegmentPath, bool optionalToStartChoiceSegmentPath, Action belongsToaction, ChoiceSegmentPath choiceSegmentPath)
        {
        ...
        /// <summary>
        /// Factory method that creates and returns a new empty instance of the optional to start choice segment path class
        /// </summary>
        /// <returns>A new empty instance of the optional to start choice segment path class</returns>
        new public OptionalToStartChoiceSegmentPath factoryMethod()
        {
        ...
        /// <summary>
        /// Method that creates a new instance of the optiona to start choice segment path class
        /// </summary>
