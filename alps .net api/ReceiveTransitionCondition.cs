    ...
    public class ReceiveTransitionCondition : MessageExchangeCondition, IReceiveTransitionCondition
    {
        ...
        public override void export(ref Graph g)
        {
            ...
            try
            {
                ...
                {
                    subject = g.CreateUriNode(name);
                    predicate = g.CreateUriNode("rdf:hasReceiveType");
                    objec = g.CreateUriNode("standard-pass-ont:" + receiveType.getModelComponentID());
                ...
                if (this.messageSentFromSubject != null)
                {
                    subject = g.CreateUriNode(name);
                    predicate = g.CreateUriNode("rdf:hasReceiveTransitionCondition");
                    objec = g.CreateUriNode("standard-pass-ont:" + this.messageSentFromSubject.getModelComponentID());
                ...
                if (this.receptionOfMessage != null)
                {
                    subject = g.CreateUriNode(name);
                    predicate = g.CreateUriNode("rdf:hasReceptionOfMessage");
                    objec = g.CreateUriNode("standard-pass-ont:" + receptionOfMessage.getModelComponentID());
