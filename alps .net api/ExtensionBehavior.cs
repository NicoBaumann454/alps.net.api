    ...
    class ExtensionBehavior : ALPSModelElement, IExtensionBehavior
    {
        ...
        public override void export(ref Graph g)
        {
            ...
            if (initialStateOfBehavior != null)
            {
                ...
                objec = g.CreateUriNode("standard-pass-ont:" + initialStateOfBehavior.getModelComponentID());
            ...
            foreach (BehaviorDescriptionComponent s in behaviorDescriptionComponent)
            {
                if (s != null)
                {
                    subject = g.CreateUriNode(name);
