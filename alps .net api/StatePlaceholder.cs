...
{
    class StatePlaceholder : AbstractPASSTransition, IStatePlaceholder
    {
        ...
        /// <summary>
        /// Constructor that creates a new empty instance of the state placeholder class
        /// </summary>
        public StatePlaceholder()
        {
            setModelComponentID("StatePlaceholder");
            setComment("The standart Element for StatePlaceholder");
        }

        /// <summary>
        /// Constructor that creates a new fully specified instance of the state placeholder class
        /// </summary>
        ...
        public StatePlaceholder(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action)
        {
