...
{
    /// <summary>
    /// Class that represents an mandatory to start choice segment path
    /// </summary>

    //Den Namen muss ich noch ändern
    public class MandatoryToStartChoiceSegment : ChoiceSegmentPath, IMandatoryToStartChoiceSegmentPath
    {
        private IAction belongsToaction;
        private IChoiceSegmentPath choiceSegmentPath;
        private string tmpBelonsToAction;
        private string tmpChoiceSegmentPath;
        /// <summary>
        /// Name of the class
        /// </summary>
        new public const string className = "MandatoryToStartChoiceSegment";

        /// <summary>
        /// Constructor that creates a new empty instance of the mandatory to start choice segment class
        /// </summary>
        public MandatoryToStartChoiceSegment()
        {
            setModelComponentID("MandatoryToStartChoiceSegment");
            setComment("The standart Element for MandatoryToStartChoiceSegment");
        }

        /// <summary>
        /// Constructor that creates a new fully specified instance of the mandatory to start choice segment class
        /// </summary>
        ...
        public MandatoryToStartChoiceSegment(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action, State endState, State initialState, bool optionalToEndChoiceSegmentPath, bool optionalToStartChoiceSegmentPath, Action belongsToaction, ChoiceSegmentPath choiceSegmentPath)
        {
        ...
        /// </summary>
        /// <returns>The action attribute of the class</returns>
        ...
        /// </summary>
        /// <returns></returns>
        public string getTmpBelonsToAction()
        {
            return tmpBelonsToAction;
        }
        ...
        /// <summary>
        /// Factory method that creates and returns a new empty instance of the mandatory to start choice segment class
        /// </summary>
        /// <returns>A new empty instance of the mandatory to start choice segment class</returns>
        new public MandatoryToEndChoiceSegment factoryMethod()
        {
            MandatoryToEndChoiceSegment mandatoryToEndChoiceSegment = new MandatoryToEndChoiceSegment();

            return mandatoryToEndChoiceSegment;
        }
