...
namespace alps.net_api
{
    ...
    /// <summary>
    /// Class that represents an mandatory to end choice segment path 
    /// </summary>

    public class MandatoryToEndChoiceSegment : ChoiceSegmentPath, IMandatoryToEndChoiceSegmentPath
    {
        ...
        /// Name of the class
        /// </summary>
        new public const string className = "MandatoryToEndChoiceSegment";

        /// <summary>
        /// Constructor that creates a new empty instance of the mandatory to end choice segment class
        /// </summary>
        public MandatoryToEndChoiceSegment()
        {
            setModelComponentID("MandatoryToEndChoiceSegment");
            setComment("The standart Element for MandatoryToEndChoiceSegment");
        }

        /// <summary>
        /// Constructor that creates a new fully specified instance of the mandatory to end choice segment class
        /// </summary>
        ...
        public MandatoryToEndChoiceSegment(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action, State endState, State initialState, bool optionalToEndChoiceSegmentPath, bool optionalToStartChoiceSegmentPath, Action belongsToaction, ChoiceSegmentPath choiceSegmentPath)
        {
        ...
        /// <summary>
        /// Factory method that creates and returns a new empty instance of the mandatory to end choice segment class
        /// </summary>
        /// <returns>A new empty instance of the mandatory to end choice segment class</returns>
        ...
        /// <summary>
        /// Method that creates a new instance of the mandatory to end choice segment class
        /// </summary>
