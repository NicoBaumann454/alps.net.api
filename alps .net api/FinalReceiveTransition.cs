...
{
    class FinalReceiveTransition : ReceiveTransition, IFinalReceiveTransition, IReceiveTransition, IFinalTransitionType
    {
        ...
        /// </summary>D:\Studium KIT\Hiwi IMI KIT\Code\alps .net api\alps .net api\FinalReceiveTransition.cs
        ...
        public FinalReceiveTransition(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition, MessageExchangeCondition messageExchangeCondition, DataMappingIncomingToLocal dataMappingIncomingToLocal, int priorityNumber, ReceiveTransitionCondition receiveTransitionCondition)
        {
        ...
        */
        ...
        /// <summary>
        /// Method that creates a new Instance of the final receive transition class
        /// </summary>
        ...
        public override void export(ref Graph g)
        {
            ...
            {
                subject = g.CreateUriNode(name);
                predicate = g.CreateUriNode("rdf:hasReceiveTransitionCondtition");
                objec = g.CreateUriNode("standard-pass-ont:" + receiveTransitionCondition.getModelComponentID());
