...
{
    class TriggerSendTransition : AbstractPASSTransition
    {
        ...
        /// Name of the class
        /// </summary>
        new public const string className = "TriggerSendTransition";

        /// <summary>
        /// Constructor that creates a new empty instance of the Trigger send transition class
        /// </summary>
        public TriggerSendTransition()
        {
            setModelComponentID("TriggerSendTransition");
            setComment("The standart Element for TriggerSendTransition");
        }

        /// <summary>
        /// Constructor that creates a new fully specified instance of the Trigger send transition class
        /// </summary>
        ...
        public TriggerSendTransition(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition, MessageExchangeCondition messageExchangeCondition, DataMappingLocalToOutgoing dataMappingLocalToOutgoing, SendTransitionCondition sendTransitionCondition)
        {
