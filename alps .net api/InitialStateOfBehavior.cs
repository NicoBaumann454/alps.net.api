...
{
    /// <summary>
    /// Class that represents an InitialStateOfBehavior
    /// </summary>

    public class InitialStateOfBehavior : State, IInitialStateOfBehavior
    {
        ...
        /// Name of the class
        /// </summary>
        new public const string className = "InitialStateOfBehavior";

        /// <summary>
        /// Constructor that creates a new empty instance of the initial state of behavior class
        /// </summary>
        public InitialStateOfBehavior()
        {
            setModelComponentID("InitialStateOfBehavior");
            setComment("The standart Element for InitialStateOfBehavior");
        }

        /// <summary>
        /// Constructor that creates a new fully specified instance of the initial state of behavior class
        /// </summary>
        ...
        public InitialStateOfBehavior(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Transition incomingTransition, Transition outgoingTransition, FunctionSpecification functionSpecification, GuardBehavior guardBehavior, Action action, Action belongsToaction)
        {
        ...
        /// <summary>
        /// Factory method that creates and returns a new empty instance of the initial state of behavior class
        /// </summary>
        /// <returns>A new empty instance of the initial state of behavior class</returns>
        new public InitialStateOfBehavior factoryMethod()
        {
        ...
        /// <summary>
        /// Method that creates a new instance of the initial state of behavior class
        /// </summary>
        ...
        /// <summary>
        /// Method that exports a initial state of behavior object to a file given in the filename
        /// </summary>
        ...
        public override void exporting(bool last, string filename)
        {
            ...
            using (StreamWriter sw = File.AppendText("../../../../" + filename + ".owl"))
            {
                ...
                {
                    sw.WriteLine("      <standard-pass-ont:belongsToAction" + " rdf:resource=\"" + belongsToAction.getModelComponentID() + "\" ></standard-pass-ont:belongsToAction>");
                }
