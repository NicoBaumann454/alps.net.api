...
{
    class PrecedenceTransition : AbstractPASSTransition, IPrecedenceTransition
    {
        ...
        /// Name of the class
        /// </summary>
        new public const string className = "PrecedenceTransition";

        /// <summary>
        /// Constructor that creates a new empty instance of the Trigger transition class
        /// </summary>
        public PrecedenceTransition()
        {
            setModelComponentID("PrecedenceTransition");
            setComment("The standart Element for PrecedenceTransition");
        }

        /// <summary>
        /// Constructor that creates a new fully specified instance of the Trigger transition class
        /// </summary>
        ...
        public PrecedenceTransition(List<string> additionalAttribute, string modelComponentID, List<string> modelComponentLabel, string comment, SubjectBehavior subjectBehavior, Action belongsToaction, State sourceState, State targetState, TransitionCondition transitionCondition)
        {
